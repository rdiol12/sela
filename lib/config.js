...
const config = {
  ...
  mcpConfigCorePath: resolve(projectRoot, 'mcp-config-core.json'),
  ...
  costTrackingDisabled: false, // Always track costs — was broken by stale system env var override (Mar 7 2026)
