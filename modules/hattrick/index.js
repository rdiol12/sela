...
import {
  ...
  buildEconomyCheckBrief, buildEconomyCrisisModelingBrief, buildFullRefreshBrief, buildTrainingCheckBrief,
...
export default {
  ...
  briefBuilders: {
    ...
    hattrick_economy_crisis_modeling: buildEconomyCrisisModelingBrief,
  ...
  stateKeyMap: {
    ...
    hattrick_economy_crisis_modeling: 'lastEconomyCrisisModelingAt',
  ...
  projectProcess: {
    ...
    model: 'haiku',
    cycleInterval: 15 * 60_000,  // 15min independent cycle (was 5min Sonnet — cost optimization Mar 8)
  },
};
